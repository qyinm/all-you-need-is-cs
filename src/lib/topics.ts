...
export const PHASE1_TOPICS: Topic[] = [
  ...
  },
  {
    ...
    title: "Sorting",
    subtitle:
      "Ch. 7 internal sorting: searching ordered files, insertion sort, quicksort, comparison lower bounds, merge sort, heap sort, radix sort, and practical record movement.",
    complexity: "medium",
    bookChapter: "Ch. 7",
    outline: [
      { id: "7-1", label: "§7.1", title: "Searching" },
      { id: "7-2", label: "§7.2", title: "Insertion sort" },
      { id: "7-3", label: "§7.3", title: "Quick sort" },
      { id: "7-4", label: "§7.4", title: "How fast can we sort?" },
      { id: "7-5", label: "§7.5", title: "2-way merge sort" },
      { id: "7-6", label: "§7.6", title: "Heap sort" },
      { id: "7-7", label: "§7.7", title: "Sorting on several keys" },
      { id: "7-8", label: "§7.8", title: "Practical considerations for internal sorting" },
    ],
  },
  {
    id: "hash-table",
