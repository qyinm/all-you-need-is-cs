...
export const PHASE1_TOPICS: Topic[] = [
  ...
  },
  {
    ...
    title: "Linked Lists",
    subtitle:
      "Singly and doubly linked lists (Ch. 4): insert, delete, and search with pointer animations.",
    complexity: "easy",
    bookChapter: "Ch. 4",
    outline: [
      { id: "4-1", label: "§4.1", title: "Pointers and dynamically allocated storage" },
      { id: "4-2", label: "§4.2", title: "Singly linked lists" },
      { id: "4-3", label: "§4.3", title: "Polynomials as linked lists" },
      { id: "4-4", label: "§4.4", title: "Circularly linked lists" },
      { id: "4-5", label: "§4.5", title: "Additional list operations" },
      { id: "4-6", label: "§4.6", title: "Equivalence relations" },
      { id: "4-7", label: "§4.7", title: "Sparse matrices" },
